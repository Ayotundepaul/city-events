    ...
    <Container title="events" className={classes.root}>
      ...
      <Grid container spacing={4} className={classes.gridcontent}>
        <Grid item xs={12} sm={12} md={9}>
          <EventsListing data={currentPosts} />
        </Grid>
